...
# Multimodal archs allowed to keep prefill breakable CUDA graph (BCG) enabled.
# Text-only batches capture/replay; batches carrying input_embeds/replace_embeds
# are rejected by can_run_graph and fall back to eager, so vision requests are
# unaffected.
