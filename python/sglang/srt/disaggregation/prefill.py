...
class SchedulerDisaggregationPrefillMixin:
    ...
    def maybe_send_cached_prefix_chunk(self: Scheduler, req: Req) -> None:
        ...
        # Snapshot the at-rest prefix on the request's first batch: on later
        # batches prefix_indices grows to cover launched chunks whose forward
        # output may still be unresolved under overlap scheduling.
        if req.early_send_prefix_end is None:
        ...
        cached_end = req.early_send_prefix_end
    ...
    def send_kv_chunk(
        ...
        for seg_start, seg_end in segments:
            ...
            kv_indices = (
                self.req_to_token_pool.req_to_token[req.req_pool_idx, seg_start:seg_end]
                .cpu()
                .numpy()
            )
