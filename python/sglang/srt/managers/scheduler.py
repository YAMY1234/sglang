    ...
    def _get_new_batch_prefill_raw(
        ...
        for req in self.waiting_queue:
            ...
            if (
                ...
                # hit (consumed through init_load_back) plus the auxiliary
                # device state consumption allocates and request-pins. Set
                # AFTER init_next_round_input (which recomputes host hits), so
                # the ordinary SWA and Mamba admission gates charge it.
