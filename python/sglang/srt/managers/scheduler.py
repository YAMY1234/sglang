    ...
    def _get_new_batch_prefill_raw(
        ...
        for req in self.waiting_queue:
            ...
            if (
                ...
                # init_next_round_input (which recomputes host_hit). A staged
                # Mamba state slot is request-pinned at consumption, so it is
                # charged through mamba_host_hit_length the same way.
