...
class SchedulerLoadInquirer:
    ...
    get_last_dp_dispatch_seq: Callable
    get_dp_collective_epoch: Callable
    ...
    def get_loads(self) -> LoadSnapshot:
        ...
        return LoadSnapshot(
            ...
            dp_collective_epoch=self.get_dp_collective_epoch(),
            timestamp=time.time(),
            ...
            last_dp_dispatch_seq=self.get_last_dp_dispatch_seq(),
