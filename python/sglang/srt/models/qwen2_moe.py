...
class Qwen2MoeSparseMoeBlock(nn.Module):
    ...
    def _forward_deepep(self, hidden_states: torch.Tensor, forward_batch: ForwardBatch):
        ...
        if hidden_states.shape[0] > 0:
            ...
            if enable_dual_stream:
                ...
                if is_in_breakable_cuda_graph():
                    # The routed-expert call below is an eager break. Keep the
                    # event record and wait in the same capture; this preserves
                    # allocator safety even though it cannot retain overlap.
        ...
        if enable_dual_stream:
            wait_share_stream()
        elif enable_cuda_shared_overlap and not is_in_breakable_cuda_graph():
