    ...
    def __init__(
        ...
        with self._draft_context():
            bundle = build_draft_tp_worker(
                ...
                # Only the final PP stage constructs the draft. Reuse the
                # target's seed so it does not enter the all-stage WORLD
                # broadcast while earlier stages proceed to KV sizing.
